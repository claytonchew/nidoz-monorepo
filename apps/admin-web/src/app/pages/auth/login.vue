...
<i18n lang="yaml">
	en: Login: Login LoginDescription: Enter your credentials to access your
	account. ms: Login: Log Masuk LoginDescription: Masukkan kelayakan anda untuk
	mengakses akaun anda. zh: Login: 登录 LoginDescription:
	输入您的凭据以访问您的帐户。
</i18n>
